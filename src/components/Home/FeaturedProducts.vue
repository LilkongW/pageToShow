...
<v-row dense>
    ...
    <v-card class="rounded-lg">
        ...
        class="rounded-t-lg"
        >
        <template v-if="product.discount > 0" #append>
            <v-badge
            color="error"
        ...
        <div class="d-flex align-center gap-2">
            <span class="text-lg font-weight-bold" :class="product.discount > 0 ? 'text-error' : 'text-primary'">
...
const discountedPrice = (product: typeof featuredProducts[number]) => {
